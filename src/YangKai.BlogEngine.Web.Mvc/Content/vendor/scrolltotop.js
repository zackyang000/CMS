...
var scrolltotop={
	...
	controlHTML: '<img src="/Content/img/up.png" style="width:32px; height:32px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
	...
	togglecontrol: function () {
		...
		if (this.state.shouldvisible && !this.state.isvisible) {
		    ...
		    var that = this;
		    setTimeout(function () { that.$control.stop().hide(); }, that.setting.fadeduration[1]);
