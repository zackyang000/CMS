...
if ((_ref = window.Pace) == null) window.Pace = {};
...
Events = (function() {
  ...
  Events.prototype.on = function(name, fn) {
    var _base, _ref1;
    if ((_ref1 = (_base = this.bindings)[name]) == null) _base[name] = [];
...
ElementMonitor = (function() {
  ...
  function ElementMonitor(options) {
    var selector, _i, _len, _ref1, _ref2;
    if (options == null) options = {};
    this.elements = [];
    if ((_ref1 = options.selectors) == null) options.selectors = [];
...
Pace.go = function() {
  ...
  return animation = runAnimation(function(frameTime, enqueueNextFrame) {
    var avg, count, done, element, elements, i, j, remaining, scaler, scalerList, source, start, sum, _i, _j, _len, _len1, _ref1, _ref2, _ref3;
    remaining = 100 - bar.progress;
    count = sum = 0;
    done = true;
    for (i = _i = 0, _len = sources.length; _i < _len; i = ++_i) {
      source = sources[i];
      scalerList = (_ref1 = scalers[i]) != null ? _ref1 : scalers[i] = [];
...
if (typeof define === 'function' && define.amd) {
  ...
  if (options.startOnPageLoad) Pace.start();
}
